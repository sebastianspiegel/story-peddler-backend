...
james.plot_points << PlotPoint.create(description: "The crew captures a flock of seagulls to fly the peach through the sky.")
james.plot_points <<  PlotPoint.create(description: "James is sent to bed with no dinner by his mean aunts.")
james.plot_points <<  PlotPoint.create(description: "The crew parties and eats lots of peach!")
...
tangled.plot_points << PlotPoint.create(description: "Rapunzel and Prince Charming live happily ever after.")
tangled.plot_points << PlotPoint.create(description: "The prince climbs Repunzel's hair.")
tangled.plot_points << PlotPoint.create(description: "Rapunzel lets down her hair.")