...
james = Story.create(user_id: 1, title: "James and the Giant Peach", genre: "Adventure", summary: "An orphaned boy finds a magical peach and goes on a great adventure with a crew of larger-than-life insects.")
...
tangled = Story.create(user_id: 1, title: "Rapunzel", genre: "Romance", summary: "A princess with long hair is recused from a tower by a brave prince.")
...
starwars = Story.create(user_id: 1, title: "Star Wars", genre: "SciFi", summary: "The Imperial Forces -- under orders from cruel Darth Vader -- hold Princess Leia hostage, in their efforts to quell the rebellion against the Galactic Empire. Luke Skywalker and Han Solo, captain of the Millennium Falcon, work together with the companionable droid duo R2-D2 and C-3PO to rescue the beautiful princess, help the Rebel Alliance, and restore freedom and justice to the Galaxy.")
